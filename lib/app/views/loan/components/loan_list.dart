...
class LoanList extends StatelessWidget {
  ...
  const LoanList({Key key, @required this.data})
      : assert(data != null),
        super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GroupedListView<Loan, String>(
        shrinkWrap: true,
        padding: EdgeInsets.zero,
        elements: this.data,
        order: GroupedListOrder.DESC,
        groupBy: (Loan loan) => loan.createdAt.split('T')[0],
  ...
  Widget _itemBuilder(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          NumberFormat.currency(decimalDigits: 0).format(loan.nominal),
          maxLines: 1,
          overflow: TextOverflow.ellipsis,
        ),
        onTap: () {},
